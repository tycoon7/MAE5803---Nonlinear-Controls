%%
function HW2P2_plotPhasePortrait(eqnum,tspan,xLimits,yLimits,plotTitle)
% PLOTPHASEPORTRAIT plots the phase portrait
set(0,'DefaultTextInterpreter','latex')
figure();
hold on
for i = linspace(xLimits(1),xLimits(2),7)
...
elseif flag == 3   
    dx(1) = x(2);
    dx(2) = x(1)^2*sin(x(1))^8*cos(3*x(1))^2 - x(1)^7 - x(2)^5;
